...
class Food extends egret.Shape{
    constructor(type: number, sitePoint?: egret.Point){
        super();
        this.foodType = type;
    ...
    public foodType : number; // 食物类型
    public sitePoint : egret.Point; // 食物坐标
    public food : egret.Shape; // 食物，自己画
    public food2 : egret.Bitmap; // 食物，图片资源
    ...
    // 产生半径为r的圆形糖豆
    private createRoundFood(r: number): egret.Shape{
    ...
    // 生成磁铁
    private createMagnetFood(r: number): egret.Shape{
        let magnet = new egret.Shape();
